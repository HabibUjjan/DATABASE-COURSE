...
insert into students values (1, 'Habib'), (2, 'Sakina');
insert into courses values (101, 'database systems'), (102, 'OOP');
insert into student_courses values (1, 101, '2025-06-15');
...
insert into appointments values (1, 101, '2024-02-10');
